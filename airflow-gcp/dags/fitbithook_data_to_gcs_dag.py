...
from plugins.fitbit_hook import FitbitHook
...
@provide_session
def create_fitbit_connection(session=None):
    try:
...
# Create the connection when the DAG is loaded
create_fitbit_connection()
...
if (__name__ == "__main__") and os.environ.get("GCP_PROJECT_ID"):
    dag.test()
    # example arguments
